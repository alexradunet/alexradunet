...
- Local-first AI tools and agent-native developer environments
- Private, secure systems aligned with EU values
- Pi.dev-based appliances and AI-augmented engineering workflows
- TypeScript agent tooling, mobile apps (Flutter), and self-hosted services
- Creative software at the edge of tech and human practice
- Simple, maintainable code that survives the next team handover
